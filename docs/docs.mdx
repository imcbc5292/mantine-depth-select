...
<Demo data={demos.controlsJustify} />
...
Items don't need to be cards — any React content
works. This example uses emoji with varying widths
to test how different-sized content behaves:

<Demo data={demos.emoji} />
